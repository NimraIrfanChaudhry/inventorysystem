...
namespace ePOSOne.btnProduct
{
    public class Button_WOC : Button
    {
        ...
        protected override void OnPaint(PaintEventArgs e)//customize button
        {
            base.OnPaint(e);
            Graphics g = e.Graphics;
            g.SmoothingMode = System.Drawing.Drawing2D.SmoothingMode.AntiAlias;//This makes the edges of shapes and lines smoother, improving the appearance of the button.
            ...
            g.DrawString(Text, Font, brush, (Width - stringSize.Width) / 2, (Height - stringSize.Height) / 2);//The text's position is calculated so that it is horizontally and vertically centered.
        }
        ...
        public Color BorderColor
        {
            ...
            {
                _borderColor = value;
                Invalidate();//which forces the button to redraw itself with the new border color.
            }
        }
